				...
				<div className="container-fluid bg-dark App-background">
					...
					<div className="row text">
						<div className="col-lg-12">
							<p className="text">
								...
								Varius morbi enim nunc faucibus a pellentesque sit amet. A
								iaculis at erat pellentesque adipiscing commodo elit at
								imperdiet. Nam aliquam sem et tortor. At imperdiet dui accumsan
								sit amet nulla facilisi morbi. Elit sed vulputate mi sit amet
								mauris. A lacus vestibulum sed arcu non odio euismod. Nibh nisl
								condimentum id venenatis a condimentum vitae sapien
								pellentesque. Diam volutpat commodo sed egestas egestas
								fringilla. Etiam dignissim diam quis enim lobortis. Imperdiet
								sed euismod nisi porta lorem. Vulputate sapien nec sagittis
								aliquam. Laoreet sit amet cursus sit.{" "}
							</p>
						</div>
					</div>
					<div className="row">
					...
					<div className="row button-row">
						<div className="col-sm-4">
							<TextButton text="Model 1" modelName="Model 1" />
						</div>
						<div className="col-sm-4">
							<TextButton text="Model 2" modelName="Model 1" />
						</div>
						<div className="col-sm-4">
							<TextButton text="Model 3" modelName="Model 1" />
						</div>
					</div>
				</div>
			</div>
